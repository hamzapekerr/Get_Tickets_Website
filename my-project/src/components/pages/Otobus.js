                            ...
                            <div className="tab-container">
                                <div className="tab-content">
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-sm-6">
                                            <button type="button" className="btn btn-danger my-4 col-sm-12">Otobüs Bileti Bul
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-6 col-md-6 d-none d-md-block">
                            <div className="card text-white arka mb-3">
                                ...
                                <div className="card-body">
                                    <p className="card-text">Şehirler arası yolculuklarınızı keyifli ve konforlu hale getirin! Tumbilet ile otobüs bileti satın alarak hedefinize rahatlıkla ulaşın.</p>
                                </div>
                            </div>
                        </div>
                    </div>
